...
function createDiv() {
  ...
  if (document.querySelector('li.el-dropdown-menu__item.active')) {
    delay(100).then(
      () =>
        (document.querySelector('li.el-dropdown-menu__item.active').className = document
          .querySelector('li.el-dropdown-menu__item.active')
